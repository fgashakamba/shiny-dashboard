...
country <- st_read(file.path(paste0(path, "/Rw_geodata_wgs84.gpkg")), layer = "country")
lakes <- st_read(file.path(paste0(path, "/Rw_geodata_wgs84.gpkg")), layer = "lakes")
np <- st_read(file.path(paste0(path, "/Rw_geodata_wgs84.gpkg")), layer = "national_parks")
districts <- st_read(file.path(paste0(path, "/Rw_geodata_wgs84.gpkg")), layer = "districts")
